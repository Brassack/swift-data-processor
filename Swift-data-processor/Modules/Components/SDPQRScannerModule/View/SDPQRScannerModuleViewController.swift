...
class SDPQRScannerModuleViewController: UIViewController, SDPQRScannerModuleViewInput, SDPViewExternalConfiguratorProtocol {
    
    var output: SDPQRScannerModuleViewOutput!
